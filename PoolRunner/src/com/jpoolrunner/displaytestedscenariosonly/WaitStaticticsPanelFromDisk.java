...
public class WaitStaticticsPanelFromDisk extends JPanel {
	 ...
	 * @param strategyName 
	 */
	public WaitStaticticsPanelFromDisk(String strategyName, Vector<JobPercentiles> jobPercentilesVector) {
		...
		// TODO Auto-generated constructor stub
				...
				while(it.hasNext()){
					JobPercentiles hgg=(JobPercentiles)it.next();
				 	bins.add(hgg.getFiftyPercentileWt()); 
				 	bins.add(hgg.getNintyPercentileWt()); 
				}
		   ...
		   //   String[]  categoryKeys = seriesKeys;
			...
			//	ValueAxis rageAxis = plot.getRangeAxis();
				...
				chart.setTitle(fontSetting.getTextTitle("Wait Time Percentiles: "+tpsName));
